...
class MovieUserRatingModel(models.Model):
    ...
    user_id = models.ForeignKey(CustomUesr, on_delete=models.CASCADE, null=True)
    movie_id = models.ForeignKey(MovieModel, on_delete=models.CASCADE, null=True)
    rating = models.FloatField(choices=RATE_CHOICES, null=True)
